...
public class Application {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n\n----------------------------FILTER CUSTOMER ITERATOR--------------------------------------");
		Iterator<Customer> iterator1 = customerCollection.filterCustomerIterator(customer -> {
			return customer.getAddress().getCity().equals("Chicago") ||
					customer.getAddress().getZip().startsWith("12");
		});
		while (iterator1.hasNext()) {
			System.out.println(iterator1.next());
		}

		System.out.println("\n\n----------------------------SKIP CUSTOMER ITERATOR--------------------------------------");
		Iterator<Customer> iterator2 = customerCollection.skipCustomerIterator();
